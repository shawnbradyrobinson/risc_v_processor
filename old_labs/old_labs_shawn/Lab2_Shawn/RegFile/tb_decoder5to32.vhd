...
architecture behavioral of tb_decoder5to32 is
  ...
  signal s_input_address		     : std_logic_vector(4 downto 0) := x"00000";  
...
--  end process;
  ...
  begin
    ...
    s_input_address   <= x"00101";
    wait for 100 ns; 
    -- Expect enabled_line_out to be "00000000000000000000000000010000" -- 00000010 in hex


    -- Access 'RISC-V saved register 1...s0 = x8'
    s_input_address   <= x"01000";
    wait for 100 ns; 
    ...
    s_input_address   <= x"01010";
    wait for 100 ns; 
    -- Expect enabled_line_out to be "0000_0000_0000_0000_0000_0100_0000_0000" -- 00000800 in hex 

    -- Access 'RISC-V return address register...ra = x1'
    s_input_address   <= x"00001";
    wait for 100 ns; 
    -- Expect enabled_line_out to be "00000000000000000000000000000001" -- 00000001 in hex 
