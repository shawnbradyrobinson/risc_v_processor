...
-- DATA MEMORY BLOCK
	...
	MEMORY_BLOCK: mem
		...
		port map(
			clk		=> clk_dp,
			addr		=> s_result(11 downto 2), --if I want to implement the full RISC-V someday, this changes to 9downto0
			data		=> s_rs2_out,
			we		=> MemWrite,
			q		=> s_mem_output
		);
