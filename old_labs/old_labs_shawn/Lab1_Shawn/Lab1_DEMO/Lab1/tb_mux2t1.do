...
## tb_mux2t1.do
#########################################################################
## DESCRIPTION: This file contains a do file for the testbench for my personal 
## implementation for the mux2t1 
##              
## NOTES:
##	-based on the version provided to us in tb_TPU_MV_ELEMENT.do 
#########################################################################
