...
-- tb_mux2t1.vhd
-------------------------------------------------------------------------
-- DESCRIPTION: This file contains a testbench for my mux 2:1 design from lab 1 
--              
...
signal s_i_D0 : std_logic_vector(N-1 downto 0) := (others => '0'); 
signal s_i_D1 : std_logic_vector(N-1 downto 0) := (others => '0');  
