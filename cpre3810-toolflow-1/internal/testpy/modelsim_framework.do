...
log -r *
add wave -r -position insertpoint sim:/tb/MyRiscv/*
...
# add wave -position insertpoint sim:/tb/MyRiscv/yourcomponent/*



# Students should not modify below this point.
mem load -infile imem.hex -format hex /MyRiscv/IMem
mem load -infile dmem.hex -format hex /MyRiscv/DMem
run 10000000
quit
